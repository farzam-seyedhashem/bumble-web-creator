    ...
    return (
        <>
            <div className={"relative group"}>
                {value ?
                    <img className={"z-[1]"} style={isDesktop ? {...styles.global, ...styles.desktop} : {...styles.mobile, ...styles.global}} onClick={() => setIsSelected(true)} src={value}/> :
                    <div  style={isDesktop ? {...styles.global, ...styles.desktop} : {...styles.mobile, ...styles.global}} onClick={() => setIsSelected(true)}
