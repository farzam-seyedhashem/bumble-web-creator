...
export default function IconComponent({editDialogOpenComponentId,setEditDialogOpenComponentId,color,isDesktop,editItem, item, key,removeItemFunc,dragFunc}) {
    ...
    return (
        <>
            <Icon fill={isFill ? 1 : 0} weight={styles[isDesktop?"desktop":"mobile"].fontWeight} size={styles[isDesktop?"desktop":"mobile"].fontSize} id={key}
                  className="relative group w-full" style={isDesktop ? {...styles.global, ...styles.desktop} : {...styles.mobile, ...styles.global}}>
                {value}
                <div
