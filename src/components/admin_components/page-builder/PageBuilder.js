		...
		<div className={"flex  bg-surface-container-low-light dark:bg-surface-container-low-dark"}>
			...
			<div
				...
				<div
					...
					<Link href={type==="template"?"/admin/page-builder/templates":"/admin/page-builder/pages"}
			...
			<div
				...
				<div style={{backgroundColor: rgbaObjToRgba(siteSetting.color.background)}}
				     className={"z-10 rounded-[16px] min-h-screen "}>
