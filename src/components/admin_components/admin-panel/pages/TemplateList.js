					...
					<DialogPanel
						...
						<div className={"space-y-3"}>
							...
							{selectedIndexType === 1 && <Select value={newPageData.type} label={"Template type"}>
								...
								<ListItem headline={"component"}
								          onClick={() => updateNewPageData("type", "component")}/>
							</Select>}
						</div>
					...
					<div
						...
						<table
							...
							{data.map(page => <tr key={page._id} className={"*:px-4 *:h-[56px] "}>
								...
								<td>
									<div
										className={"h-[32px] px-3 w-fit text-label-large font-medium flex justify-center items-center rounded-[8px] text-on-secondary-container-light dark:text-on-secondary-container-dark bg-secondary-container-light dark:bg-secondary-container-dark"}>
