...
export default function MenuEditor({menuSetting, siteSetting, data}) {
	...
	const [menuListItems, setMenuListItems] = useState(menuSetting.menuItems || {mobileAppbar: [], mobileBottomMenu: [], desktopAppbar:[]})
	...
	const onMenuItemChange = (menuType,items)=> {
		if (menuType==="desktop-menu"){
			setMenuListItems({...menuListItems, ["desktopAppbar"]: items})
			console.log(menuListItems)
		}else if(menuType==="appbar-menu"){
			setMenuListItems({...menuListItems, ["mobileAppbar"]: items})
		}else if(menuType==="bottom-menu"){
			setMenuListItems({...menuListItems, ["mobileBottomMenu"]: items})
		}
		console.log(menuListItems)
	}
				...
				<div className={"space-x-4 flex "}>
					...
					<div className={"w-4/12"}>
						...
						<ul className={"py-2"}>
							...
							<h3 className={"px-4 text-on-surface-light dark:text-on-surface-dark text-title-medium font-bold"}>
								Desktop Menu Items
							</h3>
							<p className={"px-4 mb-2 w-9/12 text-body-medium text-on-surface-variant-light dark:text-on-surface-variant-dark"}>
								Edit desktop menu items list
							</p>
							<MenuItemEditor menuListItems={menuListItems.desktopAppbar} onMenuItemChange={onMenuItemChange} editMenuItemType={"desktop-menu"} menuSetting={menuSetting} color={color}
							                pages={data} menuItems={""}>
								Edit Desktop Menu
							</MenuItemEditor>
						</ul>
						<div className={"w-full pt-2 pb-4"}>
				...
				<div className={"space-x-4 flex"}>
					...
					<div className={"w-4/12 "}>
						...
						<ul className={"py-2"}>
							...
							<p className={"px-4 mb-2 w-9/12 text-body-medium text-on-surface-variant-light dark:text-on-surface-variant-dark"}>
								Edit Bottom menu items list
							</p>
							<MenuItemEditor menuListItems={menuListItems.mobileBottomMenu} onMenuItemChange={onMenuItemChange} editMenuItemType={"bottom-menu"} menuSetting={menuSetting} color={color}
							                pages={data} menuItems={""}>
								Edit Mobile Bottom Menu
							</MenuItemEditor>
						</ul>
						<div className={"w-full pt-2 pb-4"}>
							<Divider type={"inset-middle"} className={""}/>
						...
						<ul className={"py-2"}>
							...
							<h3 className={"px-4 text-on-surface-light dark:text-on-surface-dark text-title-medium font-bold"}>
								Mobile Appbar Menu Items
							</h3>
							<p className={"px-4 mb-2 w-9/12 text-body-medium text-on-surface-variant-light dark:text-on-surface-variant-dark"}>
								Edit appbar menu items list
							</p>
							<MenuItemEditor menuListItems={menuListItems.mobileAppbar} onMenuItemChange={onMenuItemChange} editMenuItemType={"appbar-menu"} menuSetting={menuSetting} color={color}
							                pages={data} menuItems={""}>
								Edit Mobile Appbar Menu
							</MenuItemEditor>
						</ul>
						<div className={"w-full pt-2 pb-4"}>
							<Divider type={"inset-middle"} className={""}/>
