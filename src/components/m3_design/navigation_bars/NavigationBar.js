    ...
    return (
        <div
            ...
            <button className={" pt-3 pb-4 w-full"}>
                ...
                <label className={"text-label-medium font-medium text-center text-on-surface-light dark:text-on-surface-dark"}>
                    Label
                </label>
            </button>
            <button className={" w-full"}>
                ...
                <label className={"text-center text-label-medium font-medium text-on-surface-variant-light dark:text-on-surface-variant-dark"}>
                    Label
                </label>
            </button>
        </div>
