...
export default function IconButton(props) {
    const {component,color, onClick, type, children, className, selected,rooClassName, ...other} = props
    ...
    return (
        <Component onClick={(e) => {
            // createRipple(e)
            onClick && onClick()
        }} {...other} className={`group/icon-button icon-button-container ${rooClassName}`}>
